...
class HistoryServiceTest {
    ...
    void 첫_페이지_hasNext_true_nextCursor_반환() {
        ...
        HistoryResponse response = historyService.getHistories(10L, 1L, UserRole.EMPLOYER, null, 2);
    ...
    void 다음_페이지_after_있으면_cursor_변환해서_repository_호출() {
        ...
        historyService.getHistories(10L, 1L, UserRole.EMPLOYER, after, 2);
    ...
    void 고용주_권한_체크() {
        ...
        assertThrows(UnauthorizedException.class,
                () -> historyService.getHistories(10L, 99L, UserRole.EMPLOYER, null, 20));
    }
    ...
    void 근로자_권한_체크() {
        ...
        assertDoesNotThrow(() -> historyService.getHistories(10L, 2L, UserRole.WORKER, null, 20));
    }
}
